...
def node():
    global frontiers, mapData, global1, global2, global3, globalmaps, litraIndx, n_robots, namespace_init_count, filterpub
    ...
    arraypoints = PointArray()  # 在循环之前初始化
